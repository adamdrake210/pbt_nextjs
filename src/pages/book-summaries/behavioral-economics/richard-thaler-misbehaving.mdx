...
description:
  'Read Misbehaving by Richard Thaler for an introduction to the exciting world of Behavioral Economics and learn about how human decision-making is usually anything but rational.'
...
This is the story of a sometimes vicious battle between traditional economists and the growing school of behavioral economists to which Thaler belongs, told in an understandable way with a good dose of humour thrown in as well. 
'
slug: 'richard-thaler-misbehaving'
category: 'behavioral-economics'
tags: 'behavioral-economics, thinking fast and slow, prospect-theory, richard thaler'
...
One example. Early in his teaching career, he set a particularly difficult exam for his students in order to separate the extremely capable from the rest. This led to an average score of 72 out of 100 and caused “uproar” among his students who complained the exam was too hard. Because the score was graded on a curve, the average score did not actually affect the distribution of the grades, but this failed to appease the angry students. Thaler’s solution was to tweak the next exam to make the total number of available points 137 instead of 100. The next exam was even harder but, because the average score was 97, the students were happy. 
...
Other people were asking the same questions. Throughout Misbehaving, Thaler introduces us to a stellar cast of Behavioral Economics thinkers including Daniel Kahneman (author of [Thinking Fast and Slow](https://www.amazon.com/Thinking-Fast-Slow-Daniel-Kahneman/dp/0374533555/ref=sr_1_1?dchild=1&keywords=Thinking+Fast+and+Slow&qid=1595680819&s=books&sr=1-1)), Amon Taversky (Kahneman’s long-time collaborator), Cass Sunstein (co-author of [Nudge](https://www.amazon.com/Nudge-Improving-Decisions-Health-Happiness/dp/014311526X) along with Thaler) and many more who led the fight against a powerful opposition in the form of traditional economists, wedded to their theories.
...
For example, consider options for gaining $100. For the first option, you are given $200 initially and then you lose $100. For the second option you just are just given $100. Econs would not care about which option happened to them because the ultimate [‘utility’](https://en.wikipedia.org/wiki/Utility) is the same in both cases. But, real people prefer the second option because they feel losses more strongly than gains.

For a good overview of Prospect Theory, [check out this article on Investopedia](https://www.investopedia.com/terms/p/prospecttheory.asp).

**The Endowment Effect**
Coined by Thaler in 1980, the Endowment Effect can be seen as an extension of Prospect Theory because it builds on the concept of loss aversion. It also relates to the Mere Ownership Paradigm, which is based on experiments finding that people give higher valuations to items they own compared to people the valuations of people who do not own the same items.
...
As well as Thinking Fast and Slow, I also recommend reading Michael Lewis' [The Undoing Project: A Friendship That Changed Our Minds](https://www.amazon.com/Undoing-Project-Friendship-Changed-Minds/dp/0393354776/ref=sr_1_1?dchild=1&keywords=the+undoing+project&qid=1595682838&s=books&sr=1-1) which tells the story of the birth of Behavioral Economics through the prism of Daniel Kahneman and Amos Tversky's friendship and [The Victory Lab: The Secret Science of Winning Campaigns](https://www.amazon.com/Victory-Lab-Science-Winning-Campaigns/dp/0307954803) by Sasha Issenberg, which takes you into the world of politics and shows the gradual impact of behavioral economics and data on the science of winning elections.
...
Richard Thaler is an American theorist in behavioral economics. In 2017, he was awarded the Nobel Memorial Prize in Economic Sciences and in 2018, he was elected a member in the National Academy of Sciences. He has published six books including [Nudge](https://www.amazon.com/Nudge-Improving-Decisions-Health-Happiness/dp/014311526X/ref=sr_1_1?dchild=1&keywords=nudge&qid=1595682513&s=books&sr=1-1), which he co-authored with Cass Sunstein.
