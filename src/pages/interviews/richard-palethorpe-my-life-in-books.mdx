...
that it is accurate, neat and tidy. In fact only the final proofs and
techniques, refined over many years or centuries are concise, neat, 
logical steps.
...
behaviours my code is capable of vastly exceeds what I can compute in
my head or even formally verify. Taleb can tell you the same thing
despite not being an expert in my area[1]. He points out that people
...
of randomness is modelled by fat-tailed probability distributions. It
...
world and he’s a bit of a character who sees it as his moral duty to
...
[1]Of systems coding in particular, he is a finance quant which requires considerable coding abilities.
...
and therefore genetics. It's only where pure thought is concerned that
...
Dune of course is a work of fiction and therefore is expressed in a way
...
sand worms occasionally uttering simplified dialogue designed to reach
...
progressive is less likely to switch to conservative, than a hard-line
...
there is the opportunity for pandemonium.
...
developed an ideology", then check out  [Industrial Society and Its
...
man-made more powerful than technology, it co-opted religion and now
...
oceans, conspiracy theories, mind-altering substances...
