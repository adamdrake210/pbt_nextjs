...
description:
  'In his book The Art of Learning - Josh Waitzkin walks the leader through his
...
<p style={{ fontSize: '20px' }}>
  ...
  <strong>The Art of Learning by Josh Waitzkin</strong> - and I was very
  captivated by one idea. The idea of <strong>'building your trigger'</strong>.
  The reason I was so caught by this idea was the practicality and potential
  wide range of use for it.
</p>

> "Josh's idea is to work on a routine over a period of 30 days for example
> where would work on purely getting yourself into the zone, into a state
> of flow."
...
you work purely on getting yourself into the zone or into a state of flow.
...
<Image266x400
  src="josh-waitzkin-art-of-learning_aqomaf"
  altText="The Art of Learning - Josh Waitzkin"
  imageCategory="book-summaries"
/>

<Box textAlign="center">
  <AmazonCta link="https://www.amazon.com/gp/product/0743277465/ref=as_li_tl?ie=UTF8&camp=1789&creative=9325&creativeASIN=0743277465&linkCode=as2&tag=paperbacktrav-20&linkId=d3357e90f7c3c96b77475117658f3e07" />
</Box>
